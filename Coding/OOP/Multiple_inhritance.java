...
interface FeaturesOFBicycle1{
    int tyres = 2 ;
    void Clutch();
    void breakUp();
}
class AvonBicycle1 extends another implements BiCycle1, FeaturesOFBicycle1{
    int speed = 120;
    //    int tyres = 4 ;
    void blowHorn(){
    ...
    public void display(){
        System.out.println("Another class display in AvonBicycle...");
    }
}
